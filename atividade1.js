...
// let sobrenome = "Ferreira"; // SyntaxError: Identifier 'sobrenome' has already been declared
...
// fazendo cada mensagem aparecer em uma linha separada no console.//1
var nome = 'Ronaldo';           //variáveis em commonjs
let profissao = "Professor";    //variáveis ES5/ES6 
const cidade = `Floriano`;      //constantes
//2
console.log(nome);
console.log(profissao);
console.log(cidade);
